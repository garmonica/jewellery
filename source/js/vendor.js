...
(function (global, factory) {
  ...
  const Swiper = /*#__PURE__*/function () {
    ...
    _proto.emitContainerClasses = function emitContainerClasses() {
      ...
      const classes = swiper.el.className.split(' ').filter((className) => className.indexOf('swiper-container') === 0 || className.indexOf(swiper.params.containerModifierClass) === 0);
    ...
    _proto.mount = function mount(el) {
      ...
      const getWrapperSelector = function getWrapperSelector() {
